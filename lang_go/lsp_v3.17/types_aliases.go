...
// by the client.
// "OneOf" union-type semantics: only at-most one field is ever set, all others will be null/undefined/nil/empty/etc.
...
type DocumentFilter struct {
	TextDocumentFilter             *TextDocumentFilter             /*OPT:TextDocumentFilter*/
